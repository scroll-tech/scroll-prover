...
Both YUL and bytecode of verifier contract could be generated when running aggregation tests (`make test-agg-prove`), and named as `evm_verifier.yul` and `evm_verifier.bin` files.
