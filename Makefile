...
prove: ## generate multiple-erc20-trace and write into files.
	@./target/release/prove --params zkevm/test_params --rng zkevm/test_seed --trace zkevm/tests/trace-multiple-erc20.json --evm evm_proof_multiple-erc20 --state state_proof_multiple-erc20
