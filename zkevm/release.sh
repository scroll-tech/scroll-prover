...
function run_agg_tests() {
	...
	RUST_LOG=info PARAM_SEED=bb4b94a1bbef58c4b5fcda6c900629b5 MODE=multi cargo test --features prove_verify --release test_agg -- --nocapture 2>&1 | tee logs/4in1.log.multi
	RUST_LOG=debug PARAM_SEED=bb4b94a1bbef58c4b5fcda6c900629b5 MODE=sushi cargo test --features prove_verify --release test_agg -- --nocapture 2>&1 | tee logs/4in1.log.sushi
